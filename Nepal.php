...
<head>
  ...
  <title>unwpa-nepal-ambassador</title>
            ...
            <div class="card card-cascade narrower bg-dark pt-0">
              ...
              <div class="d-flex align-self-center">
                ...
                <div class="container country-name">
                  <h1 class="responsive-font" style="background-image: linear-gradient(blue, orange);"><div class="spinner-grow text-light mb-md-1 mb-lg-2 mb-xl-2.8" style="animation-duration: 2s;" role="status"></div>NEPAL<div class="spinner-grow text-light mb-md-1 mb-lg-2 mb-xl-2.8" style="animation-duration: 2s;" role="status"></div></h1>
                </div>
              </div>
              <div style="text-align-left"> 
                ...
                <div class="image-top text-white" style="font-size:2vw;">
                  <p class="intro bg-gradient">UNWPA NEPAL AMBASSADOR</p> 
                </div>
              </div>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                ...
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/Nepal.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
                  <div class="text-white mt-5">
                      <div class="ambassador-1">H.E PIYARATNA MAHARJAN</div>
