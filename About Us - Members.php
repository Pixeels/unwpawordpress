  ...
  <?php include 'includes/header.php' ?>
    ...
    <div class="container-fluid m-0 p-0 memberTitleContainer">
        <div class="row m-0 p-o memberTitleCont2">
            <div class="col-sm-6 p-5 mt-5 container-fluid d-flex justify-content-center align-items-center titleCont">
        ...
        <div class="row m-0 p-0">
            <div class="col-sm-10 m-0 members_seperatorbg1">
                <div class="position-absolute top-75 start-50 translate-middle px-5 py-2 membersTitleBg">
                    <h1 class="text-center boardTitle"> UNWPA JAPAN BOARD MEMBERS </h1>
                </div>
            </div>
        </div>
