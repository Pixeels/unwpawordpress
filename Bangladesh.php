        ...
        <div class="row">
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                ...
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/1.1png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
                  <div class="text-white mt-5">
                      <div class="ambassador-1">H.E RATAN KUMAR DAS</div>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/2.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
                  <div class="text-white mt-5">
                    <div class="ambassador-2">H.E SYED AZMUL HAQUE</div>
                    <div class="bg-warning rounded p-1 flex-fill">
                    </div>
                    <p class="card-text fs-6 fst-italic">REPRESENTATIVE FOR OPERATION MANAGEMENT (BANGLADESH)</p>
                  </div>
                </div>
              </div>
          </div>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/3.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
                  <div class="text-white mt-5">
                    <div class="ambassador-3">H.E MD ARIFUL ISLAM</div>
                    <div class="bg-warning rounded p-1 flex-fill">
                    </div>
                    <p class="card-text fs-6 fst-italic">REPRESENTATIVE OF FOREIGN AFFAIRS (BANGLADESH)</p>
                  </div>
                </div>
              </div>
          </div>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/4.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/5.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/6.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/7.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/8.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/9.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/my-logo/10.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
