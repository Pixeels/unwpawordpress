<?php
  /* Template Name: Conference - Participation*/
?>
<html>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/scss/conference.css">
<body>
  <!-- Header Section -->
  ...
  <div class="container-fluid px-5 my-5 participation-section">
      <div class="row">
            <div class="col-sm-6 p-0">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/conference-participation/bangladesh1.jpg" class="w-100" alt="">
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 p-0">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/conference-participation/thailand1.jpg" class="w-100" alt="">
              </div>
    ...
    <div class="container-fluid px-5">
        ...
        <div class="row">
            <div class="col-sm-7 gallery-show">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/conference-participation/a56b8f48ef874e873085544ad8ddb193_609ccfb8c01a2b250c8c23f951b8b949.jpg" class="img-fluid w-100" alt="">
        ...
        <div class="row">
            ...
            <div class="col-sm-7 gallery-show">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/conference-participation/09839e240c8600d2e793b0543c3f8e95_52001487273c6776cd75dfedf86d48cb.jpg" class="img-fluid w-100" alt="">
                <div class="gallery-layer d-flex align-items-end bd-highlight mb-3">
                    <div class="gallery-context ms-5 mb-5 pb-5">
