      ...
      <div class="row m-0 p-0 mt-5">
        <div class="d-flex justify-content-start">
          <div class="row m-0 p-0">
            <div class="col-sm-3">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/homepage/logo.png" alt="" class="img-fluid">
            </div>
          ...
          <div class="d-flex  justify-content-around my-4">
            <ul class="nav col-md-4list-unstyled text-light ">
              <li class="ms-3"><a class="text-primary" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/social media/email.png" width="20px" alt=""></svg></a></li>
              <li class="ms-3"><a class="text-muted" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/social media/facebook.png" width="20px" alt=""></a></li>
              <li class="ms-3"><a class="text-muted" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/social media/twitter.png" width="20px" alt=""></a></li>
            </ul>
          </div>
        </div>
    </div>
    ...
    <footer class="d-lg-none d-sm-block responsive-footer">
              <div class="row d-flex justify-content-center py-5">
                  <div class="col-sm-4 parent-logo">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/homepage/footer-unwpa-logo.png" alt="" class="img-fluid w-100 logo p-2">
                  </div>
            ...
            <div class="d-flex  justify-content-around my-4">
              <ul class="nav col-md-4list-unstyled text-light ">
                <li class="ms-3"><a class="text-primary" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/social media/email.png" width="40px" alt=""></svg></a></li>
                <li class="ms-3"><a class="text-muted" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/social media/facebook.png" width="30px" alt=""></a></li>
                <li class="ms-3"><a class="text-muted" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/social media/twitter.png" width="35px" alt=""></a></li>
              </ul>
            </div>
      <div class="row m-0 p-0">
          <p class="text-center text-light" style="font-size: 12px;">COPYRIGHT &copy | UNITED NATION WORLD PEACE ASSOCATION | ALL RIGHTS RESERVED</p>
