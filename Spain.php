        ...
        <div class="row">
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                ...
                <div class="view overlay text-center">
                  <img src="assets/my-logo/Spain1.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="assets/my-logo/Spain2.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
          ...
          <div class="column col-lg-4 col-md-12 mb-4">
              <div class="card bg-dark">
                <!-- Card image -->
                <div class="view overlay text-center">
                  <img src="assets/my-logo/Spain3.png" class="card-img-top"
                    alt="">
                  <a>
                    <div class="mask"></div>
                  </a>
